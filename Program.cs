...
options.UseSqlServer(builder.Configuration.GetConnectionString("Proiect_MediiContext") ?? throw new InvalidOperationException("Connectionstring 'Proiect_MediiContext' not found.")));
